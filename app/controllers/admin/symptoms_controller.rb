class Admin::SymptomsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @symptom.save
        format.html { redirect_to admin_symptom_path(@symptom), notice: 'Symptom was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @symptom.update(symptom_params)
        format.html { redirect_to admin_symptom_path(@symptom), notice: 'Symptom was successfully updated.' }
  ...
  def import
    Symptom.import(params[:file])
    redirect_to admin_symptoms_url, notice: "Symptom data imported"
  end
  ...
  private
    ...
    def symptom_params
      params.require(:symptom).permit(:name, :description, :specialization_area_id)
    end
end
